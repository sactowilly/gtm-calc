...
- **Version 2.5 - Backup and Restore (in progress):** the complete read-only JSON/checksum foundation is merged and validated local backup download is the current slice; restore preview, transactional merge/replace, CSV exports, quote JSON export, and PDF export remain later reviewable slices.
