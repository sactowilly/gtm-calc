...
- **Version 3.0 - Progressive Web App (accepted stable release):** install metadata, public-shell caching, offline calculator/library readiness, deliberate safe-update activation, and the Android PDF-open fallback are complete. See [docs/V3_RELEASE_CHECKLIST.md](docs/V3_RELEASE_CHECKLIST.md) and [installation guidance](docs/INSTALLATION.md).
- **Version 3.5 - Mobile workflow (in progress):** inline Item-field search reduces quote-entry context switching while preserving manual-item protection and the standalone Catalog workspace. See [docs/V35_IMPLEMENTATION_PLAN.md](docs/V35_IMPLEMENTATION_PLAN.md).
...
- `docs/V35_IMPLEMENTATION_PLAN.md` - staged mobile-workflow plan, beginning with inline item search
