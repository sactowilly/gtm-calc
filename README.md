...
- **Version 3.5 - Mobile workflow (active planning):** reduce quote-entry context switching, starting with inline item search in the Quote workspace. See [docs/V35_IMPLEMENTATION_PLAN.md](docs/V35_IMPLEMENTATION_PLAN.md).
