...
- **Version 2.5 - Backup and Restore (in progress):** the complete read-only JSON/checksum foundation is underway; validated download, restore preview, transactional merge/replace, CSV exports, quote JSON export, and PDF export follow in reviewable slices.
