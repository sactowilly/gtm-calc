...
| Version 3.0 PWA implementation | in progress | The `shell-cache.2` slice adds a `/gtm-calc/`-scoped worker and versioned public bootstrap cache without fetch interception, customer/business-data caching, or offline claims. Next: offline shell and local-data readiness. |
