...
| Version 2.5 backup and restore | in progress | PR 1 backup foundation, PR #24 local Export/download, PR #25 preview-only inspection, and PR #26 transactional Merge/Replace restore are merged. PR 5 adds CSV and individual quote exports; PR 6 still requires physical release evidence, closeout, and owner acceptance. |
