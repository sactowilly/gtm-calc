...
| Version 2.5 backup and restore | complete | PRs #24–#28 delivered the Export workspace, validated backup download, safe inspection, transactional Merge/Replace restore, CSV/individual exports, and release closeout. Owner Android Chrome/laptop Chromium acceptance and post-merge Pages verification passed on 2026-08-06. The annotated `v2.5.0` tag is the final release action. |
...
| Version 3.0 PWA planning | active planning | Begin manifest, service-worker cache policy, offline-shell, update-notification, and cache-migration design only after the annotated `v2.5.0` tag is published. |
