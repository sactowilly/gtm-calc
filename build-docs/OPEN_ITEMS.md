...
| Version 2 quote-library foundation | in progress | Branch `feature/v2-quote-library-foundation`; separate IndexedDB repository is not yet connected to the visible UI. |
