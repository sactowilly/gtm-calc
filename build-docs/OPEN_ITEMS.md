...
| Version 2.5 backup and restore | release hardening | PR 1 backup foundation, PR #24 local Export/download, PR #25 preview-only inspection, PR #26 transactional Merge/Replace restore, and PR #27 CSV/individual exports are merged. PR6 closeout is on `feature/v25-release-closeout`; physical release evidence, owner acceptance, post-merge Pages smoke, and the annotated `v2.5.0` tag remain open. |
