...
| Version 3.0 PWA planning | active planning | V2.5 is tagged `v2.5.0`; begin manifest, service-worker cache policy, offline-shell, update-notification, and cache-migration design from the verified recovery boundary. |
