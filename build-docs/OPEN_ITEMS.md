...
| Version 2.5 backup and restore | complete | PRs #24–#29 delivered the Export workspace, validated backup download, safe inspection, transactional Merge/Replace restore, CSV/individual exports, release closeout, and acceptance documentation. Owner Android Chrome/laptop Chromium acceptance and post-merge Pages verification passed on 2026-08-06. Annotated tag `v2.5.0` identifies production commit `7ab4d2e`. |
| Version 2.5 physical acceptance | complete | Samsung Galaxy S24 Ultra/Chrome and Dell desktop/Chrome passed backup/restore, safety-backup recovery, rollback, exports, privacy, corrupted-file no-write, immutable-record, accessibility, and keyboard checks on 2026-08-06. |
| Version 3.0 PWA implementation | complete | PR #39 (`0f15230`) corrected the hidden-control regression; GitHub Actions run `34266091373` and Pages deployment `34268352795` passed. Owner Android Chrome/laptop Chromium acceptance is recorded; iPhone Safari is explicitly deferred. Stable tag publication follows the closeout documentation merge. |
| Version 3.5 mobile workflow | active planning | First slice: inline catalog/My Items search from the Quote workspace Item field, reducing catalog-page context switching while preserving dirty line-item input, privacy boundaries, and the standalone Catalog workflow. |
