...
- Version 2 is complete and tagged `v2.0.0` at verified production commit `b61890c`. Version 2.5 is complete and tagged `v2.5.0` at verified production commit `7ab4d2e`. Version 3.0 is accepted for stable release with marker/package `v3.0.0 · stable` / `3.0.0`; Version 3.5 mobile-workflow planning is active.
