...
- Physical Version 2.5 backup-download/restore evidence and owner acceptance are complete. The annotated `v2.5.0` tag remains the final release action. PWA implementation is now the active Version 3.0 planning scope; deletion/archive, backend, authentication, synchronization, and hosted access remain deferred according to the roadmap, `V25_IMPLEMENTATION_PLAN.md`, and `V25_RELEASE_CHECKLIST.md`.
