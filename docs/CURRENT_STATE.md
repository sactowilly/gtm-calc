...
## Current implementation update — 2026-08-04
...
- Version 2 is complete and tagged `v2.0.0` at verified production commit `b61890c`. Version 2.5 is in release hardening with marker `v2.5.0 · release-closeout.6` and package version `2.5.0-alpha.6` on its current feature branch.
...
- Physical Version 2.5 backup-download/restore evidence, owner acceptance, stable tagging, deletion/archive, PWA, backend, authentication, synchronization, and hosted access remain deferred according to the roadmap, `V25_IMPLEMENTATION_PLAN.md`, and `V25_RELEASE_CHECKLIST.md`.
