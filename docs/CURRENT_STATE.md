...
- Physical Version 2.5 backup-download/restore evidence, owner acceptance, post-merge Pages verification, and annotated tag publication are complete. PWA implementation is now the active Version 3.0 planning scope; deletion/archive, backend, authentication, synchronization, and hosted access remain deferred according to the roadmap, `V25_IMPLEMENTATION_PLAN.md`, and `V25_RELEASE_CHECKLIST.md`.
