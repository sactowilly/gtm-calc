...
- Version 2 is complete and tagged `v2.0.0` at verified production commit `b61890c`. Version 2.5 is complete and tagged `v2.5.0` at verified production commit `7ab4d2e`. Version 3.0 is in progress with development marker `v3.0.0 · hidden-controls.6` and package version `3.0.0-alpha.6`.
