...
- Version 2 is complete and tagged `v2.0.0` at verified production commit `b61890c`. Version 2.5 is complete after PR #28 merged as `0716350`, owner Android/laptop acceptance passed, and Pages deployment run `31128417026` succeeded. Annotated tag `v2.5.0` identifies production commit `7ab4d2e`; the development marker remains `v2.5.0 · release-closeout.6` and package version `2.5.0-alpha.6`.
...
- Physical Version 2.5 backup-download/restore evidence, owner acceptance, post-merge Pages verification, and annotated tag publication are complete. PWA implementation is now the active Version 3.0 planning scope in `V3_IMPLEMENTATION_PLAN.md`; deletion/archive, backend, authentication, synchronization, and hosted access remain deferred according to the roadmap and Version 3.5/4.0 boundaries.
