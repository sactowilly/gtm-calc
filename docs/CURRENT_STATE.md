...
- PR #12 merged the visible draft library. A post-merge Pages compatibility hotfix vendors the IndexedDB helper so the directly hosted source tree remains browser-resolvable; the visible marker is `v2.0.0 · draft-library.2`.
