...
- Owner acceptance and closeout deployment verification passed on 2026-08-06. The annotated `v2.5.0` tag remains a post-merge release action at the verified production commit.
